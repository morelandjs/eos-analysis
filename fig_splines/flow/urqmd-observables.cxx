...
int main() {
  ...
  while (std::cin) {
    ...
    auto charge = std::stoi(line.substr(159, 3));
    if (charge == 0)
      continue;
    ...
    auto px = std::stod(line.substr(81, 16));
    auto py = std::stod(line.substr(97, 16));
    auto pz = std::stod(line.substr(113, 16));
