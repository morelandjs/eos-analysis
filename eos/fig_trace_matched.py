...
e *= hbarc**3
p *= hbarc**3
plt.plot(T, (e-3.*p)/T**4, linewidth=1, color=plt.cm.Blues(0.6), label=r'HQCD matched', zorder=2)
...
e *= hbarc**3
p *= hbarc**3
plt.plot(T, (e-3.*p)/T**4, linewidth=1, color=plt.cm.Reds(0.6), label=r'WB matched', zorder=3)
...
e *= hbarc**3
p *= hbarc**3
plt.plot(T, (e-3.*p)/T**4, linewidth=1, color=plt.cm.Greens(0.6), label=r'S95 matched', zorder=1)
