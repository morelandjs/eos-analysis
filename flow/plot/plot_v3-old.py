...
def v3():
    ...
    ax3.legend(bbox_to_anchor=(0.35,0.95))
    ...
    for ax, centrality in zip(axes, centralities):
        try:
            ...
            ax.plot(pi['pt'], pi_WB['v3']/pi_HotQCD['v3'], linewidth=0.75, color=plt.cm.Blues(0.6))
            ax.plot(k['pt'], k_WB['v3']/k_HotQCD['v3'], linewidth=0.75, color=plt.cm.Oranges(0.6))
            ax.plot(p['pt'], p_WB['v3']/p_HotQCD['v3'], linewidth=0.75, color=plt.cm.Greens(0.6))
    ...
    for ax, centrality in zip(axes, centralities):
        try:
            ...
            ax.plot(pi['pt'], pi_s95['v3']/pi_HotQCD['v3'], linewidth=0.75, color=plt.cm.Blues(0.6))
            ax.plot(k['pt'], k_s95['v3']/k_HotQCD['v3'], linewidth=0.75, color=plt.cm.Oranges(0.6))
            ax.plot(p['pt'], p_s95['v3']/p_HotQCD['v3'], linewidth=0.75, color=plt.cm.Greens(0.6))
            ax.plot(np.linspace(0,3,100), np.ones(100), linewidth=0.2, color='gray')
