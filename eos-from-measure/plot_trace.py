...
plt.plot(T/1000, I, dashes=(4,1), color=orange,linewidth=1, zorder = 301, label="UrQMD")
...
plt.plot(T, I, color=green,linewidth=1, zorder = 99, label="HotQCD")
...
I = np.asarray(I)
plt.plot(Tvec, I, color=magenta, label='WB')
